...
<form:form method="POST" action="/Trane_TestCase_Repository/user_save_check_out">
<table>
<tr>
...
<tr>
<td>
<a href="/Trane_TestCase_Repository/all_landing"><button class = "button">Cancel Purchase</button></a>
</td>
<td>
<a href="/Trane_TestCase_Repository/user_save_check_out"><button class = "button">Confirm and Checkout</button></a>
</td>
</tr>
</table>
</form:form>
