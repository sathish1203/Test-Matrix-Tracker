...
<a href = "/Trane_TestCase_Repository/all_show_product?id=${productDeal.id}"><img class = img-responsive src="images\products\<c:out value="${productDeal.id}" />.jpg" alt="${productDeal.name}"> </a>
<div class="carousel-caption">
