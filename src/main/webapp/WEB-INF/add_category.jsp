...
<td align="center"><a href="/Trane_TestCase_Repository/admin_edit_category?id=${category.id}">Edit</a>|<a href="/Trane_TestCase_Repository/admin_delete_category?id=${category.id}">Delete</a></td>
</tr>
</c:forEach>
</tbody>
</table>
