...
<form:form method="POST" action="/Trane_TestCase_Repository/admin_save_product"  enctype="multipart/form-data" onsubmit = "return validateform(this);">
<table>
<tr> 
...
<td align="center"><a href="/Trane_TestCase_Repository/admin_edit_product?id=${product.id}">Edit</a>
| <a href="/Trane_TestCase_Repository/admin_delete_product?id=${product.id}">Delete</a></td>
</tr>
</c:forEach>
</table>
</c:if>
