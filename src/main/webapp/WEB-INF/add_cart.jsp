...
<div class="col-md-12">
	...
	<form:form method="POST" action="/Trane_TestCase_Repository/user_save_cart">
<table>
<tr>
...
<td>
  <a href="/Trane_TestCase_Repository/user_edit_cart?productId=${cart_pdt.key}">Edit</a>
| <a href="/Trane_TestCase_Repository/user_delete_cart?productId=${cart_pdt.key}">Delete</a>
</td>
</tr>
</c:forEach>
<tr>
...
<tr>
	<td colspan="2"><a href = "/Trane_TestCase_Repository/all_landing"><button type="button" class="btn btn-default">Continue Shopping</button></a></td>
	<td colspan="2"><a href = "/Trane_TestCase_Repository/hello.flow"><button type="button" class="btn btn-default">Checkout</button></a></td>
</tr>
</table>
</c:if>
</div>
