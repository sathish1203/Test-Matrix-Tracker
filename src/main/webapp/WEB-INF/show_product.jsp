...
<tbody>
<tr>
<td><a href = "/Trane_TestCase_Repository/all_landing"><input type = "submit" value = "CONTINUE SHOPPING"></a></td>
<td><a href = "/Trane_TestCase_Repository/user_add_cart?productId=${product.id}"><input type = "submit" value = "ADD TO CART"></a> </td>
</tr>
</tbody>
</table>
</div>
