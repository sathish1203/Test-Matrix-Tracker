...
<div class = "col-sm-4">
<a href = "/Trane_TestCase_Repository/all_show_product?id=${product.id}"><img class = img-responsive src = "images\products\<c:out value="${product.id}" />.jpg" alt = "${product.name}"></a>
