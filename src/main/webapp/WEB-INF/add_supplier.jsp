...
<div class="col-md-12">
	...
	<form:form method="POST" action="/Trane_TestCase_Repository/admin_save_supplier">
<table>
<tr>
...
<td align="center"><a href="/Trane_TestCase_Repository/admin_edit_supplier?id=${supplier.id}">Edit</a>
| <a href="/Trane_TestCase_Repository/admin_delete_supplier?id=${supplier.id}">Delete</a></td>
</tr>
</c:forEach>
</table>
</c:if>
