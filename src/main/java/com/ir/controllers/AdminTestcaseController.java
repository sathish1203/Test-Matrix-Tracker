...
import com.ir.validator.AdminTestcaseValidator;
...
@Controller
public class AdminTestcaseController extends BasicController {
	@Autowired
	AdminTestcaseValidator adminTestcaseValidator;
	/**
	 ...
	 */
	@RequestMapping(value = "/admin_add_testcase", method = RequestMethod.GET)
	public ModelAndView add_testcase(@ModelAttribute("command") Testcase testcase) {
		...
		return new ModelAndView("add_testcase", model);
	}
	 ...
	 *          -- Model and view data object 
	 */
	@RequestMapping(value = "/admin_save_testcase", method = RequestMethod.POST)
	public ModelAndView save_testcase(@ModelAttribute("command") Testcase testcase,BindingResult result, SessionStatus status) {
		...
		adminTestcaseValidator.validate(testcase,result);
		if(result.hasErrors())
		{   	
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("currentUser", get_current_user());
		...
		return new ModelAndView("redirect:/admin_add_testcase");
	}
	 ...
	 *          -- Model and view data object 
	 */
	@RequestMapping(value = "/admin_edit_testcase", method = RequestMethod.GET)
	 ...
	 *          -- Model and view data object 
	 */
	@RequestMapping(value = "/admin_delete_testcase", method = RequestMethod.GET)
